...
select base.identity_id, base.name, base.provider_id, base.slug, base.attributes, base.created, base.updated, base.deleted, base.description, base.is_group, base.email,
       users.login_name, users.password, users.modulus, users.exponent, users.issuer, users.subject_alt, users.distinguished, users.expiration, users.fingerprint
