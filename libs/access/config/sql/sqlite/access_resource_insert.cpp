...
//	params: [0]=_schema_name, [1]=_name, [2]=_slug, [3]=_attributes, [4]=_description, [5]=_criteria, [6]=_allowed;
...
namespace Jde::DB::Sqlite::AccessProcs{
	α RegisterAccessResourceInsert( IProcs& procs )ι->void{
		RegisterInsertProc( procs, "access_resource_insert", "insert into access_resources( schema_name, name, slug, attributes, created, description, criteria, allowed ) values( ?, ?, ?, ?, unixepoch(), ?, ?, ? )", 7 );
	}
}
