...
namespace Jde::Web::Client{
	struct ClientHttpStream final{
		...
		~ClientHttpStream(){ /*Trace( ELogTags::HttpClientRead, "ClientHttpStream::~ClientHttpStream" );*/ }
		//ClientHttpStream( const ClientHttpStream&& rhs ):_stream{move(rhs._stream)}{};
