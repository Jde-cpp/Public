...
import{ PageSettings } from '../model/page-settings';
import { clone } from '../../../utils/utils';
import { StringUtils } from '../../../utils/string-utils';

@Component( {
    selector: 'graph-ql-detail',
    templateUrl: './graphql-detail.html',
    styleUrls: ['./graphql-detail.scss'],
...
export class GraphQLDetail implements OnDestroy, OnInit{
	...
	async ngAfterViewInit(){
		...
		const display = (pageSettings as any)["display"] || "name";
