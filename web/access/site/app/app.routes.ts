...
import{ Applications, DetailResolver, Home, LoginPage, QLList, QLListResolver } from 'jde-framework';
...
export const routes: Routes = [
	...
	{ path: 'login', title: "Login", component: LoginPage, data: {summary: "Login to Site"} },
