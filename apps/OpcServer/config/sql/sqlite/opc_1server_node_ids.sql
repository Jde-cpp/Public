# '1' prefix keeps this first in SyncScripts' abc order - the other views select from it.
drop view if exists opc_server_node_ids;
GO
create view opc_server_node_ids as
select
	server_id,
