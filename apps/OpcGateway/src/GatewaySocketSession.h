...
namespace Jde::Opc::Gateway{
	...
	private:
		α CreateSubscription( sp<UAClient> client, flat_set<NodeId> nodes, uint32 requestId )ι->TAwait<sp<UA_CreateSubscriptionResponse>>::Task;
		α OnClose()ι->void;
		...
		α Subscribe( ServerCnnctnNK&& opcId, flat_set<NodeId> nodes, uint32 requestId )ι->void;
