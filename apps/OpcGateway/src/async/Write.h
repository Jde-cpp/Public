...
namespace Jde::Opc::Gateway{
	struct UAClient;
	struct WriteAwait final : TAwait<flat_map<NodeId,UA_WriteResponse>>{
		WriteAwait( flat_map<NodeId,Value>&& x, sp<UAClient> c, SRCE )ι:TAwait{sl}, _values{move(x)},_client{move(c)}{}
