...
namespace Jde::Opc::Gateway{
	...
	struct RequestHandler final : Web::Server::IRequestHandler{
		RequestHandler( jobject settings, sp<App::IApp> appClient, sp<QL::IQL> ql, sv defaultSslFileName )ι:Web::Server::IRequestHandler{move(settings), move(appClient), defaultSslFileName}, _ql{move(ql)}{}
