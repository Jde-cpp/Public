...
if( WIN32 )
	function( copyLibDlls )
		...
		add_custom_command( TARGET ${targetName} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_if_different "${MULTI_INSTALL_PREFIX}/zlib/bin/zlib$<IF:$<CONFIG:Debug>,d,>.dll" $<TARGET_FILE_DIR:${targetName}> COMMENT "copy zlibd.dll" )
#		add_custom_command( TARGET ${targetName} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_if_different "${MULTI_INSTALL_PREFIX}/fmt/bin/fmt.dll" $<TARGET_FILE_DIR:${targetName}>  COMMENT "fmt.dll" )
#		add_custom_command( TARGET ${targetName} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_if_different "${MULTI_INSTALL_PREFIX}/zlib/bin/zlib.dll" $<TARGET_FILE_DIR:${targetName}> COMMENT "copy zlib.dll" )
	endfunction()
