...
if( WIN32 )
	function( copyLibDlls )
		...
		add_custom_command( TARGET ${targetName} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_if_different "${buildLibDir}/framework/lib/$<CONFIG>/Jde.dll" $<TARGET_FILE_DIR:${targetName}> )
		add_custom_command( TARGET ${targetName} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_if_different "${buildLibDir}/framework/lib/$<CONFIG>/Jde.pdb" $<TARGET_FILE_DIR:${targetName}> )
