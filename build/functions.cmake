...
if( WIN32 )
	function( copyCommonDlls )
		...
		add_custom_command( TARGET ${targetName} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_if_different "${LIB_DIR}/fmt/bin/fmtd.dll" $<TARGET_FILE_DIR:${targetName}>  COMMENT "copy fmtd.dll" )
		...
		add_custom_command( TARGET ${targetName} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_if_different "${LIB_DIR}/fmt/bin/fmt.dll" $<TARGET_FILE_DIR:${targetName}>  COMMENT "copy fmt.dll" )
