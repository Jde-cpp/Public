...
if( WIN32 )
	function( copyCommonDlls )
		set( buildLibDir $ENV{JDE_BUILD_BASH_DIR}/msvc/jde/libs )
		...
		add_custom_command( TARGET ${targetName} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_if_different "${LIB_DIR}/fmt/bin/fmt${dllSuffix}.dll" $<TARGET_FILE_DIR:${targetName}>  COMMENT "copy fmtd${dllSuffix}.dll" )
		add_custom_command( TARGET ${targetName} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_if_different "${LIB_DIR}/zlib/bin/zlib${dllSuffix}.dll" $<TARGET_FILE_DIR:${targetName}> COMMENT "copy zlib${dllSuffix}.dll" )
	endfunction()
endif()
