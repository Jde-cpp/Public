...
namespace Jde::App::Client{
	...
	struct ClientSubscriptionAwait final : TAwait<RequestId>{
		ClientSubscriptionAwait( sp<AppClientSocketSession> session, string&& query, sp<QL::IListener> listener, QL::SubscriptionId clientId, SRCE )ε:
