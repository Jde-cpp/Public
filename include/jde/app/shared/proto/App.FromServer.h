...
namespace Jde::App::FromServer{
	...
	Φ ConnectionInfo( AppPK appPK, AppInstancePK instancePK, RequestId clientRequestId, const Crypto::PublicKey& appServerPublicKey )ι->Proto::FromServer::Transmission;
	...
	Φ Jwt( Web::Jwt&& jwt, RequestId requestId )ι->Proto::FromServer::Transmission;
