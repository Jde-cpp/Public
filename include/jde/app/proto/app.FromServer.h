...
namespace Jde::App::FromServer{
	...
	α ConnectionInfo( ProgramPK appPK, ProgInstPK instancePK, ConnectionPK connectionPK, RequestId clientRequestId, const Crypto::PublicKey& appServerPublicKey, Web::Server::SessionInfo&& session )ι->Proto::FromServer::Transmission;
